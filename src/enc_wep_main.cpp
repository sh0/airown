...
/**
 * \brief Function to perform wep encryption or decryption.
...
gint32 wep_decrypt(
    ...
    return do_wep(src, dst, len, wepkey, keylen, FALSE);
}

/**
 * \brief WEP encryption
 * \param src Source data buffer
 * \param dst Destination data buffer
 * \param wepkey WEP key data
 * \param weplen WEP key size
...
gint32 wep_encrypt(
    ...
    return do_wep(src, dst, len, wepkey, keylen, TRUE);
}
