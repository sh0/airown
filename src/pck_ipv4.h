...
class c_ep_ipv4 : public c_ep {
    public:
        // Constructor and destructor
        c_ep_ipv4(struct in_addr* addr);
        c_ep_ipv4(c_ep_ipv4* ep_b);
        ~c_ep_ipv4();
...
class c_layer_ipv4 : public c_layer {
    public:
        // Constructor and destructor
        c_layer_ipv4();
        ~c_layer_ipv4();
        ...
        // Types
        en_layer_type type() { return LAYER_IPV4_PCK; }
